...
public class ContactServiceImpl implements ContactService{
	...
	public Contact update(Contact contact) {
		var contactOld=contactRepo.findById(contact.getContactId()).orElseThrow(()->new ResourceNotFoundException("Contact not found!"));
	...
	@Override
	public long getTotalContacts(String contactId) {
		System.out.println("totalcontact");
		 return contactRepo.countByContactId(contactId);
	}

	@Override
	public List<Contact> getRecentlyAddedContacts(User user, int i) {
		Pageable pageable = PageRequest.of(0, i, Sort.by("createdAt").descending());
		System.out.println("reccently added contacts");
	    return contactRepo.findByUser(user, pageable).getContent();
	}
